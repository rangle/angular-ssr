...
2. If your application has custom webpack configurations and loaders, you probably will not be able to use `ng-render`. But that's alright. It just means that you will have to build your HTTP server code using webpack and use the library version of `angular-ssr`. You will follow these rough steps:
